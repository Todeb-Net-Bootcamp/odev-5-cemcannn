...
{
    public class CustomerService : ICustomerService //ICustomerService'den implement ediyoruz.
    {
        ...
        public CustomerService(ICustomerRepository repository, IMapper mapper) //ICustomerRepository sınıfının nesnesini constructor'a gönderiyoruz ve IMapper sınıfının nesnesini constructor'a gönderiyoruz.
        {
        ...
        public CommandResponse Insert(CreateCustomerRequest request)
        {
            ...
            var validator = new CreateCustomerRequestValidator(); //CreateCustomerRequestValidation sınıfının nesnesini oluşturuyoruz.
            validator.Validate(request).ThrowIfException(); //CreateCustomerRequestValidation sınıfının Validate() metodunu çağırıyoruz. ThrowIfException metodu da hata oluştuğunda exception fırlatıyor.
